...
export function mapGuiaToDatabase(payload) {
  return {
    ...
    status: payload.status || 'Aguardando XML',
    ...
    codigo_cbhpm: payload.codigo_cbhpm,
    valor: payload.valor === '' || payload.valor == null ? 0 : Number(payload.valor),
    observacoes: payload.observacoes || null,
    xml_path: payload.xml_path || null,
    data_envio: payload.data_envio || null,
    data_processamento: payload.data_processamento || null,
