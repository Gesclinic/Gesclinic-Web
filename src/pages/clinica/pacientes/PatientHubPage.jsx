...
export default function PatientHubPage() {
  ...
  const { loadPatient, patientData, loading, alerts, activePatientId } = usePatientContext();
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center py-12">
              ...
              <Button onClick={() => navigate('/clinica/pacientes')}>Voltar para Lista</Button>
            </div>
          </CardContent>
        </Card>
      </PageLayout>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
                        ...
                        {(patientData.cpf || patientData.document_id) && (
                          <div>
                            <p className="text-xs text-gray-600 font-medium">CPF</p>
                        ...
                        {age !== null && (
                          <div>
                            <p className="text-xs text-gray-600 font-medium">IDADE</p>
                        ...
                        {patientData.gender && (
                          <div>
                            <p className="text-xs text-gray-600 font-medium">SEXO</p>
                            <p className="text-sm font-semibold text-gray-900">
                      ...
                      <div className="flex flex-wrap gap-4 text-sm">
                        ...
                        {patientData.email && (
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-gray-700 truncate">{patientData.email}</span>
                          </div>
                        )}
                      </div>
                    </div>
          ...
          {activeAlerts.length > 0 && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-3">
              {activeAlerts.map((alert, idx) => {
                ...
                const textColor = alert.severity === 'error' ? 'text-red-800' : 'text-yellow-800';
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Card className="cursor-pointer hover:shadow-lg hover:border-blue-300 transition-all">
                <CardContent className="pt-6">
                  <button onClick={() => navigate('/clinica/agenda')} className="w-full text-left">
                    <div className="flex items-start justify-between mb-2">
                      <Calendar className="text-blue-600" size={24} />
                      <ArrowRight size={18} className="text-gray-400 group-hover:text-blue-600" />
                    </div>
                    <h4 className="font-semibold text-gray-900 mb-1">Agendar Atendimento</h4>
                    <p className="text-sm text-gray-600">Criar novo agendamento</p>
                  </button>
                </CardContent>
              </Card>
              ...
              <Card className="cursor-pointer hover:shadow-lg hover:border-blue-300 transition-all">
                <CardContent className="pt-6">
                  <button
                    onClick={() => navigate(`/clinica/pacientes/${patientId}/prontuario`)}
                  ...
                  >
                    ...
                    <h4 className="font-semibold text-gray-900 mb-1">Prontuário Médico</h4>
                    <p className="text-sm text-gray-600">Ver histórico e registros</p>
                  </button>
                </CardContent>
              </Card>
              ...
              <Card className="cursor-pointer hover:shadow-lg hover:border-blue-300 transition-all">
                <CardContent className="pt-6">
                  <button
                    onClick={() => navigate(`/clinica/pacientes/${patientId}/documentos`)}
                    className="w-full text-left"
                  >
                    <div className="flex items-start justify-between mb-2">
                    ...
                    <p className="text-sm text-gray-600">Gerenciar arquivos e anexos</p>
                  </button>
                </CardContent>
              </Card>
              ...
              <Card className="cursor-pointer hover:shadow-lg hover:border-blue-300 transition-all">
                <CardContent className="pt-6">
                  <button
                    onClick={() => navigate(`/clinica/pacientes/${patientId}/convenios`)}
                    className="w-full text-left"
                  >
                    <div className="flex items-start justify-between mb-2">
                    ...
                    <h4 className="font-semibold text-gray-900 mb-1">Convênios</h4>
                    <p className="text-sm text-gray-600">Gerenciar planos de saúde</p>
                  </button>
                </CardContent>
              </Card>
            </div>
          ...
          >
            ...
            <Card>
              ...
              <CardContent className="space-y-2 text-sm">
                ...
                {patientData.email && <p className="truncate">{patientData.email}</p>}
              </CardContent>
            </Card>
