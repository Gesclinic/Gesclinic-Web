...
export function ProfessionalSchedulePage() {
  ...
  function validateForm() {
    ...
    for (const interval of formData.intervals) {
      if (!interval.day_of_week && interval.day_of_week !== 0) {
        return false;
      }
      ...
      if (
        ...
        (isNaN(interval.duration_minutes) || interval.duration_minutes <= 0)
      ) {
        return false;
      }
    }
                  ...
                  <div className="grid gap-6">
                    {Object.entries(
                      schedules.reduce((acc, s) => {
                        if (!acc[s.professional_id]) {
                          acc[s.professional_id] = [];
                        }
                        ...
                        >
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-xs text-gray-500">
                              ({profSchedules.length} horário{profSchedules.length > 1 ? 's' : ''})
                            </span>
                          </div>
          ...
          <div className="app-modal-shell app-modal-shell--form app-modal-shell--wide">
            <Card className="app-modal-card shadow-2xl border-0">
              ...
              <CardHeader className="border-b shrink-0" style={{ flexShrink: 0 }}>
                <CardTitle>{editingId ? 'Editar Horários' : 'Novo Horários'}</CardTitle>
              </CardHeader>
                    ...
                    <div className="flex flex-col gap-8 max-h-[60vh] overflow-y-auto scrollbar-custom">
                      {[...formData.intervals]
                        ...
                        .map((interval, idx) => (
                          <div
                            key={interval.id || idx}
                            className={`border rounded-lg p-6 bg-gray-50 shadow-sm ${interval.blocked ? 'border-red-500 bg-red-50' : 'border-blue-200'}`}
                          >
                            <div className="flex flex-col md:flex-row md:gap-6">
                              <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                  ...
                                  <input
                                    ...
                                    step={5}
                                    value={
                                      interval.duration_minutes !== undefined &&
                                    ...
                                    onChange={(e) => {
                                      const newIntervals = [...formData.intervals];
                                      newIntervals[idx].duration_minutes =
                              ...
                              <div className="flex flex-col justify-between items-end min-w-[100px] mt-4 md:mt-0">
                                <Button
                                  ...
                                  size="sm"
                                  onClick={() => {
                                    const newIntervals = formData.intervals.filter(
                                      (_, i) => i !== idx,
                                    );
                                    setFormData({ ...formData, intervals: newIntervals });
                                  }}
                              ...
                              <div className="flex gap-4">
                                <div className="flex-1">
                                  ...
                                  <input
                                    type="time"
                                    value={
                                      interval.break_start !== undefined &&
                                      interval.break_start !== null
                                        ? interval.break_start
                                        : ''
                                    }
                                    onChange={(e) => {
                                      const newIntervals = [...formData.intervals];
                                ...
                                <div className="flex-1">
                                  ...
                                  <input
                                    type="time"
                                    value={
                                      interval.break_end !== undefined &&
                                      interval.break_end !== null
                                        ? interval.break_end
                                        : ''
                                    }
                                    onChange={(e) => {
              ...
              <form onSubmit={handleSubmitRule} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setRuleFormData({ ...ruleFormData, rule_name: e.target.value })
                    }
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setRuleFormData({ ...ruleFormData, rule_type: e.target.value })
                    }
                    className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                    disabled={submitting}
                  >
