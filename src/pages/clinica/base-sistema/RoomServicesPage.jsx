                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b">
                        <th className="text-left py-3 px-4 font-medium text-gray-700">Sala</th>
                      ...
                      {assignments.map((assignment) => (
                        <tr key={assignment.id} className="border-b hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4 text-center flex justify-center gap-2">
                            ...
                            <button
                              onClick={() =>
                                handleDelete(assignment.id, getServiceName(assignment.service_id))
                              }
                      ...
                      <div className="bg-white border border-gray-200 rounded-lg p-5 space-y-4">
                        <div className="border-b pb-3">
                          ...
                          <p className="text-sm text-gray-600 mt-1">
                            Selecione a sala e o serviço a oferecer
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500 mt-2">
                            Escolha a sala onde o serviço será oferecido
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500 mt-2">
                            Qual serviço será oferecido nesta sala
                          </p>
                        </div>
                      </div>
