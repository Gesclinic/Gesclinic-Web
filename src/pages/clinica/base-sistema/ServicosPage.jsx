...
export function ServicosPage() {
  ...
  const getDefaultCBHPMData = () => {
    return [
      {
        'ID do Procedimento': '0101010100',
        'Descrição do Procedimento':
          'Consulta - Procedimento de avaliação para fins de diagnóstico ou investigação de queixa, sintoma ou doença',
      },
      {
        'ID do Procedimento': '0101010101',
      ...
      {
        'ID do Procedimento': '0102010100',
        'Descrição do Procedimento': 'Exame clínico complementar',
      },
      ...
      {
        'ID do Procedimento': '0103010100',
        'Descrição do Procedimento': 'Administração de medicação',
      },
      ...
      {
        'ID do Procedimento': '0105010100',
        'Descrição do Procedimento': 'Coleta de material para exame',
      },
      ...
      {
        'ID do Procedimento': '0202010100',
        'Descrição do Procedimento': 'Ultrassonografia de abdômen',
      },
      ...
      {
        'ID do Procedimento': '0401010100',
        'Descrição do Procedimento': 'Eletroforese de proteínas',
      },
  ...
  const handleSelectCBHPM = (item) => {
    ...
    const codigo = normalizeCodeCBHPM(
      String(
        item['ID do Procedimento'] ||
          item['ID de Procedimento'] ||
          item['IDdoProcedimento'] ||
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        ...
        setServices(services.map((s) => (s.id === editingId ? { ...s, ...dataToSave } : s)));
      } else {
        // ===== CRIAR NOVO =====
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b bg-gray-50">
                      <th className="text-left py-3 px-4 font-semibold text-gray-700">TUSS Code</th>
                      ...
                      <tr key={service.id} className="border-b hover:bg-gray-50 transition">
                        ...
                        <td className="py-3 px-4 text-gray-600">
                          <span className="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded">
                            {service.type_billing === 'per_consultation'
                              ? 'Por Consulta'
                              : service.type_billing === 'per_hour'
                                ? 'Por Hora'
                                : service.type_billing === 'per_session'
                                  ? 'Por Sessão'
                                  : service.type_billing === 'per_package'
                                    ? 'Por Pacote'
                                    : 'Outro'}
                          </span>
                        </td>
          ...
          >
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-5 space-y-4">
              <div className="border-b pb-3">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Busque o código CBHPM ou digite os dados manualmente
                </p>
              </div>
              ...
              <div className="mb-4 relative">
                ...
                {showCBHPMDropdown && cbhpmSearch && (
                  <div
                    className="absolute mt-1 bg-white border border-gray-300 rounded-lg shadow-lg z-50 max-h-64 overflow-y-auto w-full"
                    style={{ maxWidth: 'calc(90vw - 60px)' }}
                  >
                    {loadingCBHPM ? (
                ...
                <p className="text-xs text-gray-500 mt-2">
                  💡 Selecione da lista ou deixe em branco para digitar manualmente
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-2">
                  {formData.tuss_code
                    ...
                    : 'Será preenchido ao selecionar um código CBHPM'}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-2">
                  Classifica o tipo de serviço para agendamento e faturamento
                </p>
              </div>
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-2">
                  Opcional, mas recomendado para melhor compreensão
                </p>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-5 space-y-4">
              <div className="border-b pb-3">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Configure como este serviço será agendado e faturado
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-2">
                  Define como será efetuada a cobrança ao convênio ou paciente
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  <span className="text-xs text-gray-500">
                    Pode ser incluído em guias/notas fiscais
                  </span>
                </label>
              </div>
            </div>
                  ...
                  <div className="bg-white rounded-lg p-4 border border-gray-200">
                    <label className="flex items-center gap-3 cursor-pointer">
                      <input
                        ...
                        onChange={(e) =>
                          setFormData({ ...formData, allow_scheduling_fit: e.target.checked })
                        }
                        className="w-5 h-5 rounded border border-gray-300 cursor-pointer accent-blue-600"
                        disabled={submitting}
                      />
                      ...
                      <span className="text-xs text-gray-500">
                        Permite agendamentos de último minuto
                      </span>
                    </label>
                  </div>
                  ...
                  <div className="bg-white rounded-lg p-4 border border-gray-200">
                    <label className="flex items-center gap-3 cursor-pointer">
                      <input
                        ...
                        onChange={(e) =>
                          setFormData({ ...formData, requires_authorization: e.target.checked })
                        }
                        className="w-5 h-5 rounded border border-gray-300 cursor-pointer accent-blue-600"
                        disabled={submitting}
                      />
                  ...
                  <div className="bg-white rounded-lg p-4 border border-gray-200">
                    <label className="flex items-center gap-3 cursor-pointer">
                      <input
                        ...
                        disabled={submitting}
                      />
                      <span className="text-sm font-semibold text-gray-800 flex-1">Ativo</span>
