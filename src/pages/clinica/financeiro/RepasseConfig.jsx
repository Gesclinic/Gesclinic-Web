      ...
      <div className="p-6 space-y-6">
        ...
        <Card className="shadow-lg border-primary/20">
          <CardHeader>
            ...
            <CardDescription>Defina regras de comissão para serviços específicos, grupos ou geral.</CardDescription>
          </CardHeader>
          <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
            <div className="flex flex-col space-y-1.5">
              <label>Profissional</label>
              <Select value={form.professional_id} onValueChange={(value) => setForm({ ...form, professional_id: value })}>
            ...
            <div className="flex flex-col space-y-1.5">
                ...
                <Select value={form.tipo} onValueChange={(value) => setForm({ ...form, tipo: value, service_id: null, service_group_id: null })}>
                    <SelectTrigger><SelectValue/></SelectTrigger>
                    <SelectContent>
                        <SelectItem value="servico">Serviço Específico</SelectItem>
                        <SelectItem value="grupo" disabled>Grupo de Serviços (em breve)</SelectItem>
                        <SelectItem value="geral" disabled>Geral (em breve)</SelectItem>
                    </SelectContent>
                </Select>
            </div>
            ...
            <div className="flex flex-col space-y-1.5">
              ...
              <div className="relative">
                <Input type="number" step="1" value={form.percentual} onChange={(e) => setForm({ ...form, percentual: e.target.value })} placeholder="Ex: 70" />
        ...
        <Card className="shadow-lg">
          <CardHeader>
            ...
            <CardDescription>Lista de todas as configurações de repasse salvas no sistema.</CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
              ...
              <TableBody>
                {loading ? (
                  ...
                  <TableRow><TableCell colSpan="4" className="text-center">Nenhuma regra configurada.</TableCell></TableRow>
                ) : (
                  configs.map((c) => (
                    <TableRow key={c.id}>
                      <TableCell>{professionals.find((p) => p.id === c.professional_id)?.name || 'N/A'}</TableCell>
