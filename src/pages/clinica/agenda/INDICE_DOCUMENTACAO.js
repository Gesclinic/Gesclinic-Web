...
const DOCUMENTATION_INDEX = {
  ...
  "COMECE_AQUI": {
    files: [
      "QUICK_START.js - 5 minutos para começar",
      "README.md - Visão geral e resumo",
      "ARQUITETURA_DIAGRAMA.txt - Diagramas visuais"
    ],
    time: "10 minutos"
  },
  ...
  "COMPONENTES": {
    "AgendaPage.jsx": {
      ...
      funcoes_principais: [
        "loadAgendaData() - Carrega agendamentos",
        "loadMetadata() - Carrega dados auxiliares",
        "handleSaveAppointment() - TODO: Implementar",
        "handleCancelAppointment() - TODO: Implementar",
        "handleConfirmAppointment() - TODO: Implementar",
        "handleFittingAppointment() - TODO: Implementar"
      ]
    },
    "useAgendaStore.js": {
      ...
      estados: [
        ...
        "selectedSlot - Agendamento selecionado",
        "metadata - Dados auxiliares",
        "indicators - KPIs calculados"
      ],
      funcoes_principais: [
    ...
    "AgendaFilters.jsx": {
      ...
      filtros: [
        "Busca por texto",
        "Profissional (oculto em modo profissional)",
        "Sala (oculto em modo sala)",
        "Status",
        "Convênio",
        "Serviço"
      ]
    ...
    "AgendaTimeline.jsx": {
      ...
      linhas: "~400",
      modos_renderizacao: [
        "Geral: Tabela com colunas",
        "Profissional: Grid com colunas por profissional",
        "Sala: Grid com colunas por sala"
      ]
    },
  ...
  "CHECKLIST": {
    "Estrutura": [
      "[x] AgendaPage.jsx criada",
      "[x] useAgendaStore.js criada",
      "[x] 6 componentes criados",
      "[x] roomsApi.js criada",
      "[x] Rota registrada"
    ],
    "Funcionalidade": [
      "[x] Navegação de data",
      "[x] Modos de visualização",
      "[x] Filtros combinativos",
      "[x] KPIs calculados",
      "[x] Modal com abas",
      "[ ] Salvamento em API",
      "[ ] Atualização em API",
  ...
  "ROTEIROS_POR_PERFIL": {
    "Desenvolvedor Frontend": [
      "1. Ler QUICK_START.js (10 min)",
      "2. Acessar /clinica/agenda (5 min)",
      "3. Ler AGENDA_ARQUITETURA.js (20 min)",
      "4. Explorar componentes (30 min)",
      "5. Explorar useAgendaStore (20 min)",
      "Total: ~90 minutos"
    ],
    "Desenvolvedor Backend/API": [
      "1. Ler README.md (5 min)",
      "2. Ler GUIA_INTEGRACAO_API.js (30 min)",
      "3. Completar APIs (2-3 horas)",
      "4. Testar com CHECKLIST_VALIDACAO.js (1-2 horas)",
      "Total: ~4 horas"
    ],
    "QA/Tester": [
      "1. Ler QUICK_START.js (10 min)",
      "2. Acessar /clinica/agenda (5 min)",
      "3. Ler CHECKLIST_VALIDACAO.js (20 min)",
      "4. Executar teste manual (50 min)",
      "5. Reportar bugs encontrados",
      "Total: ~90 minutos"
    ],
    "Gestor/PM": [
      "1. Ler RESUMO_EXECUTIVO (5 min)",
      "2. Ver ARQUITETURA_DIAGRAMA.txt (10 min)",
      "3. Entender funcionalidades em README.md (10 min)",
      "Total: ~25 minutos"
    ]
  },
  ...
  "IMPORTANTE": {
    "Não esquecer": [
      "✅ Implementar handlers de API em AgendaPage.jsx",
      "✅ Completar appointmentsApi.js",
      "✅ Validar permissões no backend",
      "✅ Testar com dados reais"
    ],
    "Recursos": [
      "CHECKLIST_VALIDACAO.js - 90 itens de teste",
      "ARQUITETURA_DIAGRAMA.txt - Visualização"
    ],
    "Suporte": [
      "Consulte comentários no código",
      "Veja console (F12) para erros",
      "Leia QUICK_START.js troubleshooting"
    ]
  }
};
