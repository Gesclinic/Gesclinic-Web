  ...
  const readyAppointments = useMemo(() => {
    ...
    return appointments
      ...
      .sort((a, b) => {
        ...
        if (a.status === SERVICE_STATUSES.IN_SERVICE) return -1;
        if (b.status === SERVICE_STATUSES.IN_SERVICE) return 1;
        // Depois por hora
                  ...
                  .map((apt) => (
                    ...
                    >
                      <div className="space-y-3 flex-1">
                        ...
                        <div>
                          <p className="text-xs uppercase tracking-wide text-gray-500 font-semibold">Paciente</p>
