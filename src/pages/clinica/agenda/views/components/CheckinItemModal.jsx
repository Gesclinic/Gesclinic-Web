...
export default function CheckinItemModal({
  isOpen,
  itemId,
  appointment,
  onClose,
  ...
  const handleEditarDadosCadastrais = () => {
    ...
    localStorage.setItem("checkinReturnData", JSON.stringify({
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-end sm:items-center justify-center z-50">
        <div className="bg-white rounded-t-2xl sm:rounded-lg w-full sm:w-full max-h-[90vh] overflow-auto">
              ...
              <>
                <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-800">
                      Este agendamento foi feito para um pré-paciente (agendamento rápido por telefone). 
                      É necessário criar um cadastro completo no sistema antes de prosseguir com o check-in.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <p className="text-sm text-blue-900">
                    📝 Você será redirecionado para a página de novo paciente. 
                    Após criar o cadastro, poderá realizar o check-in normalmente.
                  </p>
                </div>
              </>
            ) : (
              <>
                ...
                <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                  <p className="text-sm text-orange-900">
                    ...
                    atualizar todas as informações. Após salvar, voltará automaticamente para o check-in.
                  </p>
                </div>
              </>
            )}
          ...
          <div className="flex gap-3 p-6 border-t border-gray-200 bg-gray-50">
            ...
            <button
              onClick={isPrePatient ? () => navigate("/clinica/pacientes/novo") : handleEditarDadosCadastrais}
