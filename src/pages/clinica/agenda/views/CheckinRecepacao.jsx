              ...
              {appointments.map((apt) => (
                ...
                >
                  ...
                  <div className="text-xs text-gray-600 space-y-0.5">
                    ...
                    <p>
                      💼 {apt.service_name || "Serviço"} | 👨‍⚕️{" "}
                      {apt.professional_name || "Prof"}
                    </p>
                  </div>
                </button>
              ))}
        ...
        {selectedAppointment ? (
          <>
                ...
                <div className="mt-4 bg-rose-50 border border-rose-200 rounded-lg p-3 flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-rose-800">
                      Gerar guia ou registrar pagamento
                    </p>
                  </div>
                </div>
              )}
                ...
                <div className="mt-4 bg-green-50 border border-green-200 rounded-lg p-3 flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-800">
                      Paciente está validado e liberado
                    </p>
                  </div>
                </div>
              )}
            ...
            <div className="flex-1 overflow-y-auto p-6">
              {activeTab === "checklist" && (
                <CheckinChecklist appointment={selectedAppointment} />
              )}
