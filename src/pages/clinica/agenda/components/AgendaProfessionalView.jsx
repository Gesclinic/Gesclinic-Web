            ...
            <table className="w-full border-collapse">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr className="divide-x divide-gray-200">
                  <th className="px-4 py-3 text-left text-sm font-semibold text-gray-900 w-24">Horário</th>
                  <th className="px-4 py-3 text-left text-sm font-semibold text-gray-900 flex-1">Paciente</th>
                  <th className="px-4 py-3 text-left text-sm font-semibold text-gray-900 flex-1">Serviço</th>
                  <th className="px-4 py-3 text-left text-sm font-semibold text-gray-900 flex-1">Convênio</th>
                  <th className="px-4 py-3 text-left text-sm font-semibold text-gray-900 w-32">Status</th>
                  <th className="px-4 py-3 text-right text-sm font-semibold text-gray-900 w-20">Ações</th>
                </tr>
              </thead>
                  ...
                  <tr className="hover:bg-blue-50 transition-colors divide-x divide-gray-200 bg-blue-50">
                    ...
                    <td className="px-4 py-3 text-sm">
                      <span className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium whitespace-nowrap ${getStatusBadge(nextAppointment.status).bg} ${getStatusBadge(nextAppointment.status).text}`}>
                        {getStatusBadge(nextAppointment.status).icon} {getStatusBadge(nextAppointment.status).label}
                      </span>
                    </td>
                    <td className="px-4 py-3 text-right">
                      <button
