...
export default function AppointmentUnitedModal({
  ...
  const selectedProfessional = useMemo(
    () => professionals.find((professional) => professional.id === agendamentoData.professionalId) || null,
      ...
      <DialogContent className="app-dialog-shell app-dialog-shell--content">
        ...
        <div className="space-y-4">
                ...
                <div className="space-y-4">
                  {selectedPatient && (
                    <div className="bg-green-50 border border-green-300 rounded-lg p-3 mb-4">
                      <p className="text-sm font-semibold text-green-900">✅ Dados do paciente "{selectedPatient.patientName}" carregados</p>
                      <p className="text-xs text-green-800 mt-1">Você pode editar os dados abaixo se necessário</p>
                    </div>
                  )}
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="col-span-2 space-y-4">
                      <div className="bg-blue-50 border border-blue-300 rounded-lg p-3">
                        <p className="text-sm font-semibold text-blue-900">📋 Dados Cadastrais (Padrão TISS)</p>
                      </div>
                    ...
                    <p className="text-sm font-semibold text-gray-700 mb-3">📸 Foto do Paciente</p>
              ...
              {tabAtivo === 'status' && mode === 'reception' && (
                <div className="space-y-4">
                  <div className="bg-blue-50 border border-blue-300 rounded-lg p-3 mb-4">
                    <p className="text-sm font-semibold text-blue-900">📊 Status do Agendamento</p>
                  </div>
                  ...
                  {(agendamentoData.status === BOOKING_STATUSES.AT_CHECKOUT || 
                    ...
                    <div className="bg-orange-50 border border-orange-300 rounded-lg p-4">
                      <p className="text-sm text-orange-900 font-semibold">⚠️ Dados Obrigatórios Validados</p>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 text-xs text-blue-800 space-y-1">
                    <p><strong>🗓️ Agendado:</strong> Criado na agenda</p>
                    <p><strong>☎️ Confirmado via Telefone:</strong> Paciente confirmou por telefone</p>
                    <p><strong>💬 Confirmado via WhatsApp:</strong> Paciente confirmou por WhatsApp</p>
                    <p><strong>📍 Na Recepção:</strong> Paciente chegou e iniciou check-in</p>
                    <p><strong>🪟 No Guichê:</strong> Validando dados obrigatórios</p>
                    <p><strong>👨‍⚕️ Aguardando Profissional:</strong> Pronto para ser atendido</p>
                    <p><strong>⏳ Em Atendimento:</strong> Profissional atendendo o paciente</p>
                    <p><strong>✔️ Atendido:</strong> Atendimento finalizado</p>
                  </div>
                </div>
              )}
              ...
              {tabAtivo === 'liberacao' && isConvenioFaturado && (
                <div className="space-y-4">
                  <div className="bg-green-50 border border-green-300 rounded-lg p-3 mb-4">
                    <p className="text-sm font-semibold text-green-900">✓ Validação do Convênio</p>
                  </div>
              ...
              {tabAtivo === 'faturamento' && isConvenioFaturado && (
                <div className="space-y-4">
                  <div className="bg-purple-50 border border-purple-300 rounded-lg p-3 mb-4">
                    <p className="text-sm font-semibold text-purple-900">💰 Dados de Faturamento TISS</p>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-300 rounded-lg p-4 space-y-2 mt-6">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-bold text-gray-900">R$ {parseFloat(agendamentoData.value || 0).toFixed(2)}</span>
                    </div>
                    {parseFloat(pagamentoData.discount || 0) > 0 && (
                      <>
                        <div className="flex justify-between text-sm text-yellow-800">
                          <span>Desconto:</span>
                          <span className="font-bold">-R$ {parseFloat(pagamentoData.discount).toFixed(2)}</span>
                        </div>
                        <div className="border-t border-blue-300 pt-2 flex justify-between font-bold">
                          ...
                          <span className="text-green-700">R$ {(parseFloat(agendamentoData.value || 0) - parseFloat(pagamentoData.discount || 0)).toFixed(2)}</span>
                        </div>
                      </>
                    )}
                  </div>
              ...
              {tabAtivo === 'resumo' && (
                <div className="space-y-4 overflow-y-auto max-h-[600px]">
                  <div className="bg-gradient-to-r from-green-50 to-blue-50 border border-green-300 rounded-lg p-4 mb-4">
                    <p className="text-lg font-bold text-green-900">✅ Resumo Completo do Atendimento</p>
                    <p className="text-sm text-green-700 mt-1">Todos os dados foram salvos com sucesso</p>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      ...
                      <div>
                        ...
                        <p className="text-gray-900 font-bold">{cadastralData.document_id || '-'}</p>
                      </div>
                      <div>
                        <span className="text-gray-600 block text-xs font-semibold">Telefone</span>
                        <p className="text-gray-900 font-bold">{cadastralData.cell_phone || cadastralData.phone || '-'}</p>
                      </div>
                      <div>
                        <span className="text-gray-600 block text-xs font-semibold">Data Nasc.</span>
                        <p className="text-gray-900 font-bold">{cadastralData.birthdate || '-'}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      ...
                      <div>
                        ...
                        <p className="text-gray-900 font-bold">{agendamentoData.duration || 30} minutos</p>
                      </div>
                      <div>
                        <span className="text-gray-600 block text-xs font-semibold">Sala</span>
                        <p className="text-gray-900 font-bold">{rooms.find(r => r.id === agendamentoData.roomId)?.name || '-'}</p>
                      </div>
                      <div className="col-span-2">
                        <span className="text-gray-600 block text-xs font-semibold">Profissional</span>
                        <p className="text-gray-900 font-bold">{professionals.find(p => p.id === agendamentoData.professionalId)?.name || '-'}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-purple-50 rounded-lg p-4 border border-purple-200">
                    ...
                    <div className="grid grid-cols-1 gap-3 text-sm">
                      <div>
                        <span className="text-gray-600 block text-xs font-semibold">Nome do Serviço</span>
                        <p className="text-gray-900 font-bold">{services.find(s => s.id === agendamentoData.serviceId)?.name || '-'}</p>
                      </div>
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          <span className="text-gray-600 block text-xs font-semibold">Código</span>
                          <p className="text-gray-900 font-bold">{agendamentoData.serviceCode || '-'}</p>
                        </div>
                        <div>
                          <span className="text-gray-600 block text-xs font-semibold">Valor</span>
                          <p className="text-gray-900 font-bold">R$ {parseFloat(agendamentoData.value || 0).toFixed(2)}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="bg-orange-50 rounded-lg p-4 border border-orange-200">
                      ...
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        <div className="col-span-2">
                          ...
                          <p className="text-gray-900 font-bold">{liberacaoData.plan_name || '-'}</p>
                        </div>
                        <div>
                          <span className="text-gray-600 block text-xs font-semibold">Cartão</span>
                          <p className="text-gray-900 font-bold">{liberacaoData.card_number || '-'}</p>
                        </div>
                        <div>
                          <span className="text-gray-600 block text-xs font-semibold">Autorização</span>
                          <p className="text-gray-900 font-bold">{liberacaoData.auth_number || '-'}</p>
                        </div>
                        <div>
                          <span className="text-gray-600 block text-xs font-semibold">Código TISS</span>
                          <p className="text-gray-900 font-bold">{faturamentoData.procedure_code || '-'}</p>
                        </div>
                        <div>
                          <span className="text-gray-600 block text-xs font-semibold">Valor Faturado</span>
                          <p className="text-gray-900 font-bold">R$ {parseFloat(faturamentoData.estimated_value || 0).toFixed(2)}</p>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  {checkIsParticular(agendamentoData.payerId) && isParticular && (
                    <div className="bg-orange-50 rounded-lg p-4 border border-orange-200">
                      ...
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        <div>
                          <span className="text-gray-600 block text-xs font-semibold">Valor Total</span>
                          <p className="text-gray-900 font-bold">R$ {parseFloat(agendamentoData.value || 0).toFixed(2)}</p>
                        </div>
                        <div>
                          <span className="text-gray-600 block text-xs font-semibold">Método</span>
                          <p className="text-gray-900 font-bold">{pagamentoData.payment_method || '-'}</p>
                        </div>
                        {parseFloat(pagamentoData.discount || 0) > 0 && (
                          <>
                            <div>
                              <span className="text-gray-600 block text-xs font-semibold">Desconto</span>
                              <p className="text-yellow-700 font-bold">-R$ {parseFloat(pagamentoData.discount).toFixed(2)}</p>
                            </div>
                            <div>
                              <span className="text-gray-600 block text-xs font-semibold">Valor a Receber</span>
                              <p className="text-green-700 font-bold">R$ {(parseFloat(agendamentoData.value || 0) - parseFloat(pagamentoData.discount || 0)).toFixed(2)}</p>
                            </div>
                          </>
                        )}
                      </div>
                  ...
                  <div className="bg-emerald-50 rounded-lg p-4 border border-emerald-200">
                    ...
                    <div className="text-sm">
                      <span className="text-gray-600 block text-xs font-semibold mb-1">Status Atual</span>
                      <div className="inline-block bg-green-600 text-white px-3 py-1 rounded-full text-xs font-bold">
                        {agendamentoData.status === 'awaiting_professional' ? '⏳ Aguardando Profissional' : getFormattedStatus(agendamentoData.status)}
                      </div>
                    </div>
                  </div>
          ...
          <div className="border-t border-gray-200 p-4 bg-white flex gap-2 justify-end flex-shrink-0">
            ...
            {tabAtivo === 'cadastrais' && (
              <>
                {mode !== 'reception' && (
                  <Button variant="outline" onClick={() => setTabAtivo('dados')}>← Voltar</Button>
                )}
                <Button variant="outline" onClick={onClose}>Cancelar</Button>
            ...
            {tabAtivo === 'status' && mode === 'reception' && (
              <>
                <Button variant="outline" onClick={() => setTabAtivo('cadastrais')}>← Voltar</Button>
                <Button variant="outline" onClick={onClose}>Cancelar</Button>
                <Button
                  onClick={async () => {
                    try {
            ...
            {tabAtivo === 'pagamento' && (
              <>
                <Button variant="outline" onClick={() => setTabAtivo('liberacao')}>← Voltar</Button>
