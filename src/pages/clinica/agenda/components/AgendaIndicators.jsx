  ...
  if (loading && !indicators) {
    return (
      <div className="flex items-center justify-center py-12">
        ...
        <span className="ml-2 text-gray-600">Carregando indicadores...</span>
      </div>
    );
  }
      ...
      {indicators && formatted && (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
            ...
            {/* Tempo Médio Check-in (apenas se > 0) */}
            {formatted.tempo_checkin.value > 0 && (
              <Card
          ...
          {/* Seção Financeira (apenas gestor/admin) */}
              ...
              <div className="flex-1">
                <div className="flex justify-between mb-1">
                  ...
                  <span className="font-semibold">
                    {formatted.slots_ocupados.value}/{formatted.total_slots.value}
                  </span>
                </div>
