...
} from '@/modules/agenda/services/agenda.api.queries';
...
export default function AgendamentoEditarModal({ agendamentoId, onClose, onSuccess }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      validar();
      // PASSO 5: Enviar payload com form e múltiplos serviços
      await atualizarAgendamento({
        id: agendamentoId,
        form: form,
        appointmentServices: appointmentServices, // 🆕 Múltiplos serviços
      });
      if (onSuccess) {
        onSuccess();
      }
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 📋 MÚLTIPLOS SERVIÇOS - POSICIONADO NO TOPO */}
        <div
          style={{
            marginBottom: 24,
            padding: 16,
