...
export default function MeuComponente() {
  ...
  return (
    <div>
      <button onClick={() => agenda.goToday()}>Ir para hoje</button>
      <button onClick={() => agenda.previousDay()}>Dia anterior</button>
      <button onClick={() => agenda.nextDay()}>Próximo dia</button>
    </div>
  );
}
