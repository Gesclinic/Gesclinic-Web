        ...
        <CardContent>
          <div className="space-y-4">
            <div className="bg-blue-50 border border-blue-200 rounded p-4 text-sm font-mono">
              <div className="mb-2"><strong>Email:</strong> {debugInfo.user || "❌ undefined"}</div>
              <div className="mb-2"><strong>UserID:</strong> {debugInfo.userId?.slice(0, 8)}... </div>
              <div className="mb-2"><strong>ClinicID:</strong> {debugInfo.clinicId ? `✅ ${debugInfo.clinicId.slice(0, 8)}...` : "❌ NULL"}</div>
              <div className="mb-2"><strong>Role:</strong> {debugInfo.currentRole || "❌ undefined"}</div>
            ...
            {debugInfo.clinicId ? (
              ...
              <div className="bg-red-50 border border-red-200 rounded p-4">
                ...
                <p className="text-red-700 text-sm mt-2">Você precisa fazer logout e login novamente para recarregar a sessão.</p>
                <Button 
