                ...
                <TableBody>
                  {appointments.map((a) => (
                    <TableRow key={a.id}>
                      ...
                      <TableCell className="text-center"><Badge>{a.status}</Badge></TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {commissions.map((c, i) => (
                    <TableRow key={i}>
                      <TableCell>{String(c.reference_month).padStart(2, '0')}/{c.reference_year}</TableCell>
                      <TableCell className="text-right font-medium">{c.net_amount?.toFixed(2)}</TableCell>
