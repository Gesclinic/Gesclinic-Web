...
const PlanCard = ({ plan, price, features, popular = false, description }) => (
  <div
    className={`border rounded-xl p-8 flex flex-col h-full ${popular ? 'border-primary shadow-2xl' : 'border-border'}`}
  >
    {popular && (
  ...
  return (
    <div className="bg-background text-foreground">
      <Helmet>
        ...
        <meta
          name="description"
          content="Escolha o plano ideal para sua clínica. Planos flexíveis para todos os tamanhos de negócio, do Essencial ao Enterprise."
        />
      </Helmet>
