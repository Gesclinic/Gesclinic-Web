  ...
  return (
    <div className="bg-background text-foreground">
      <Helmet>
        ...
        <meta
          name="description"
          content="Leia os Termos de Serviço que regem o uso da plataforma Gesclinic Web."
        />
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="prose prose-lg max-w-4xl mx-auto">
          ...
          <p>
            ...
            ou software) no site Gesclinic Web, apenas para visualização transitória pessoal e não
          ...
          <p>
            ...
            poderá ser rescindida por Gesclinic Web a qualquer momento.
          </p>

          <h2>3. Isenção de responsabilidade</h2>
          <p>
            Os materiais no site da Gesclinic Web são fornecidos 'como estão'. Gesclinic Web não
          ...
          <p>
            Os materiais exibidos no site da Gesclinic Web podem incluir erros técnicos,
            tipográficos ou fotográficos. Gesclinic Web não garante que qualquer material em seu
            site seja preciso, completo ou atual. Gesclinic Web pode fazer alterações nos materiais
            contidos em seu site a qualquer momento, sem aviso prévio. No entanto, Gesclinic Web não
            se compromete a atualizar os materiais.
          </p>

          <h2>6. Links</h2>
          <p>
            O Gesclinic Web não analisou todos os sites vinculados ao seu site e não é responsável
            pelo conteúdo de nenhum site vinculado. A inclusão de qualquer link não implica endosso
            por Gesclinic Web do site. O uso de qualquer site vinculado é por conta e risco do
            usuário.
          </p>

          <h3>Modificações</h3>
          <p>
            O Gesclinic Web pode revisar estes termos de serviço do site a qualquer momento, sem
