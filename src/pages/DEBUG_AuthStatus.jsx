...
export default function DebugAuthStatus() {
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'monospace', whiteSpace: 'pre-wrap' }}>
      ...
      <p>
        <strong>User:</strong> {JSON.stringify(auth.user, null, 2)}
      </p>
      <p>
        <strong>ClinicId:</strong> {auth.clinicId || '❌ NULL'}
      </p>
      <p>
      ...
      <p>
        <strong>IsAuthenticated:</strong> {auth.isAuthenticated ? '✅ true' : '❌ false'}
      </p>
    </div>
  );
}
