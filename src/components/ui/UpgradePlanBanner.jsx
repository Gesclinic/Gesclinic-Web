        ...
        <div className="text-center">
          <div className="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-red-100 mb-4">
            <svg className="h-6 w-6 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4v2m0 4v2M6.92 5.08A9.002 9.002 0 1018 12" />
            </svg>
          </div>
          ...
          <p className="text-sm text-gray-500 mb-6">
            O recurso "<strong>{featureNames[feature] || feature}</strong>" não está disponível no seu plano atual.
          </p>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            ...
            <p className="text-xs text-blue-700 mt-2">
              Faça upgrade para o <strong>Plano {upgradeOption}</strong> para desbloquear este recurso.
            </p>
          </div>
