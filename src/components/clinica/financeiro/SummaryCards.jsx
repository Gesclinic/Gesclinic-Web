  ...
  const cards = [
    {
      ...
      value: open.reduce((acc, it) => acc + Number(it.amount || 0), 0),
    ...
    },
    {
      key: 'overdue',
      label: 'Total vencido',
      value: overdue.reduce((acc, it) => acc + Number(it.amount || 0), 0),
      icon: AlertTriangle,
    ...
    {
      key: 'period',
      label: 'Total do período filtrado',
      value: periodItems.reduce((acc, it) => acc + Number(it.amount || 0), 0),
      icon: CalendarDays,
    ...
    {
      key: 'next7',
      label: 'Total próximos 7 dias',
      value: next7.reduce((acc, it) => acc + Number(it.amount || 0), 0),
      icon: Clock,
