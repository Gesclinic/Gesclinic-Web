  ...
  return (
    <form className="space-y-3 max-w-md" onSubmit={handleSave}>
      <div>
        ...
        <input className="input" name="guide_number" type="text" value={fields.guide_number} onChange={handleChange} />
      </div>
      <div>
        <label className="block font-medium">Senha/Autorização</label>
        <input className="input" name="authorization_code" type="text" value={fields.authorization_code} onChange={handleChange} />
      </div>
      <div>
        <label className="block font-medium">Tipo de Guia</label>
        <input className="input" name="type" type="text" value={fields.type} onChange={handleChange} />
      </div>
      <div>
        <label className="block font-medium">Validade Senha</label>
        <input className="input" name="valid_until" type="date" value={fields.valid_until} onChange={handleChange} />
      </div>
      <div>
        <label className="block font-medium">Status Autorização</label>
        <input className="input" name="status" type="text" value={fields.status} onChange={handleChange} />
      </div>
      <div>
        <label className="block font-medium">Observações</label>
        <textarea className="input" name="observations" value={fields.observations} onChange={handleChange} />
      </div>
