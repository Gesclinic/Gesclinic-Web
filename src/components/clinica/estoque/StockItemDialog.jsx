  ...
  useEffect(() => {
    if (initialData) {
      setFormData({
        ...
        cost_price: initialData.cost_price !== null && initialData.cost_price !== undefined ? initialData.cost_price : '',
        ...
        units_per_package: initialData.units_per_package !== null && initialData.units_per_package !== undefined ? initialData.units_per_package : '',
        description: initialData.description || '',
        min_stock: initialData.min_stock !== null && initialData.min_stock !== undefined ? initialData.min_stock : '',
        max_stock: initialData.max_stock !== null && initialData.max_stock !== undefined ? initialData.max_stock : '',
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="app-dialog-shell app-dialog-shell--content app-dialog-shell--wide">
        ...
        {/* CONTENT */}
        <form id="product-form" onSubmit={handleSubmit} className="flex-1 overflow-y-auto px-6 pt-6 pb-2 space-y-5">
            ...
            {/* SEÇÃO 1: IDENTIDADE DO PRODUTO */}
                <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-5 mb-5">
                  ...
                  <div className="grid grid-cols-3 gap-5">
                    <div>
                      <label className="block text-sm font-semibold text-gray-900 mb-3">Código (SKU)</label>
                      <Input
                        value={formData.sku}
                        onChange={(e) => { setFormData({ ...formData, sku: e.target.value }); setSkuEdited(true); }}
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-900 mb-3">Marca/Fabricante</label>
                      <Input
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-5 mb-5">
                  ...
                  <div className="grid grid-cols-3 gap-5">
                    <div>
                      <label className="block text-sm font-semibold text-gray-900 mb-3">Unidade de Medida</label>
                      <select
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-900 mb-3">Preço de Custo</label>
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-900 mb-3">Armazenagem</label>
                      <select
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-5 mb-5">
                  <div className="flex items-center gap-3 border-b pb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Registro, código de barras e avisos críticos</p>
                    </div>
                  </div>

                  <div className="grid grid-cols-2 gap-5">
                    <div>
                      <label className="block text-sm font-semibold text-gray-900 mb-3">Registro ANVISA</label>
                      <Input
                        value={formData.anvisa_registration}
                        onChange={(e) => setFormData({ ...formData, anvisa_registration: e.target.value })}
                        placeholder="Ex: 10012345-6"
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                      />
                      <p className="text-xs text-gray-500 mt-2">Para medicamentos e dispositivos médicos</p>
                    </div>
                    <div>
                      <label className="block text-sm font-semibold text-gray-900 mb-3">Código de Barras (EAN)</label>
                      <Input
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-900 mb-3">Avisos Críticos</label>
                    <Textarea
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-2">Alertas obrigatórios: Receita, Controlado, Tóxico, COM</p>
                  </div>
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-5 mb-5">
                  ...
                  <div className="grid grid-cols-2 gap-5">
                    <div>
                      <label className="block text-sm font-semibold text-gray-900 mb-3">Fornecedor Padrão</label>
                      <Input
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-900 mb-3">Unidades por Embalagem</label>
                      <Input
                        type="number"
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-5 mb-5">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-900 mb-3">Descrição Detalhada</label>
                    <Textarea
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm resize-none"
                    />
                    <p className="text-xs text-gray-500 mt-2">Especificações técnicas, compatibilidades e indicações</p>
                  </div>
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-5 mb-5">
                  ...
                  <div className="grid grid-cols-2 gap-5">
                    <div>
                      <label className="block text-sm font-semibold text-gray-900 mb-3">Estoque Mínimo</label>
                      <Input
                        type="number"
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-900 mb-3">Estoque Máximo</label>
                      <Input
                        type="number"
