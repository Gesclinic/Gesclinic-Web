...
export default function StockSupplierDialog({ open, onOpenChange, onSubmit, initialData = null }) {
  ...
  const handleAddDocument = () => {
    setFormData({
      ...
      documents: [
        ...formData.documents,
        { id: Date.now(), type: 'sanitary', file: null, fileName: '', expiryDate: '' },
      ],
    });
  };
      ...
      <DialogContent className="app-dialog-shell app-dialog-shell--content app-dialog-shell--wide">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-orange-100 text-sm">
                Gerencie informações e documentos do fornecedor
              </p>
            </div>
          </div>
          <button
        ...
        >
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-5 mb-5">
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-900 mb-3">
                Rua <span className="text-red-600 font-bold">*</span>
              </label>
              <Input
            ...
            {formData.documents && formData.documents.length > 0 ? (
              <div className="space-y-3 max-h-64 overflow-y-auto">
                {formData.documents.map((doc) => {
                  ...
                  return (
                    <div
                      key={doc.id}
                      className="flex flex-col gap-3 p-4 bg-gradient-to-r from-orange-50 to-yellow-50 rounded-lg border border-orange-200"
                    >
                        ...
                        {requiresExpiry && (
                          <div className="flex-1">
                            ...
                            <Input
                              ...
                              onChange={(e) =>
                                handleDocumentChange(doc.id, 'expiryDate', e.target.value)
                              }
                              className="text-sm"
                            />
                          </div>
              ...
              <div className="p-6 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300 text-center">
                ...
                <p className="text-xs text-gray-400 mt-1">
                  Clique em "Adicionar Doc" para anexar certificados
                </p>
              </div>
            )}
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-5">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-2">
                Condições especiais, histórico, preferências
              </p>
            </div>
          </div>
        </form>
