  ...
  const groupedAppointments = useMemo(() => {
    return appointments.reduce((acc, apt) => {
      try {
        ...
        if (!acc["Indefinido"]) acc["Indefinido"] = [];
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="mt-2 flex flex-wrap items-center gap-3 text-sm text-gray-700">
                          <span>
                            {appointment.service_name || "Procedimento não informado"}
                          </span>
      ...
      {appointments.length === 0 && (
        <div className="text-center py-12 text-gray-500">
          <svg className="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-6 4l6 6m-6-6v6m6-6h-6" />
          </svg>
