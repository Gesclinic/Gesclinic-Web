...
export default function DocumentosTab({ patientId, patientData, updatePatientData }) {
  ...
  const [uploadData, setUploadData] = useState({ file: null, title: "", type: "Exame Laboratorial" });
      ...
      >
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Exames, relatórios, prescrições e atestados
          </p>
        </div>
        <Button
      ...
      <Dialog open={showUploadDialog} onOpenChange={setShowUploadDialog}>
        <DialogContent className="app-dialog-shell app-dialog-shell--content">
          ...
          <div className="flex-1 overflow-y-auto px-6 py-6">
            ...
            <div>
              <Label htmlFor="title" className="text-sm font-medium text-gray-700">Título do Documento <span className="text-red-500">*</span></Label>
              <Input
                id="title"
            ...
            <div>
              <Label htmlFor="type" className="text-sm font-medium text-gray-700">Tipo de Documento <span className="text-red-500">*</span></Label>
              <select
                id="type"
            ...
            <div>
              <Label htmlFor="file" className="text-sm font-medium text-gray-700">Selecionar Arquivo <span className="text-red-500">*</span></Label>
              <input
                id="file"
                type="file"
                onChange={(e) =>
