  ...
  const HeaderPreview = () => (
    ...
    >
      <div className="flex items-center gap-3">
        <img src={logoUrl || logoFallback} alt="Logo preview" className="h-8 w-8 object-contain" />
        <div>
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="flex justify-between items-center mb-5">
                <h2 className="text-lg font-semibold text-gray-800">Configurações da Clínica</h2>
