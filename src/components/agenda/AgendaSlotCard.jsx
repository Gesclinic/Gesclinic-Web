...
export default function AgendaSlotCard({
  ...
  const status = agendamento?.status || (isLivre ? 'disponivel' : '');
  ...
  return (
    ...
    >
      ...
      >
        {agendamento.patient_prontuario || '—'}
      </div>
      <div
        style={{
          width: 160,
      ...
      >
        {agendamento.plan_name || agendamento.notes || ''}
      </div>
      <div
        style={{
          width: 130,
