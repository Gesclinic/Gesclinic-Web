...
export function ProfessionalServicesTab({ profesionalId, clinicId, submitting }) {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      await professionalServicesApi.updateProfessionalServiceById(editingAssignment.id, {
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          <div className="border-b pb-3 mb-4">
            ...
            <p className="text-sm text-gray-600 mt-1">
              Escolha um serviço para atribuir ao profissional
            </p>
          </div>
                        ...
                        <td className="p-2 text-center">
                          {service?.service_category ? (
                            <span className="inline-block px-2 py-1 bg-purple-100 text-purple-700 rounded text-xs font-semibold">
                              {service.service_category === 'consultation'
                                ? 'Consulta'
                                : service.service_category === 'exam'
                                  ? 'Exame/SADT'
                                  : service.service_category === 'procedure'
                                    ? 'Procedimento'
                                    : 'Outro'}
                            </span>
                          ) : (
                  ...
                  <div className="p-6 space-y-6">
                    ...
                    <div className="bg-gradient-to-br from-blue-50 via-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-5">
                      <div className="flex items-center gap-2 mb-5">
                        ...
                        <h4 className="text-sm font-bold text-blue-950 uppercase tracking-widest">
                    ...
                    <div className="bg-gradient-to-br from-emerald-50 to-green-50 border-2 border-emerald-200 rounded-xl p-5">
                      <div className="flex items-center gap-2 mb-5">
                        ...
                        <h4 className="text-sm font-bold text-emerald-950 uppercase tracking-widest">
                          ⚙️ Configurações
                        </h4>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-3 gap-3">
                          ...
                          <div className="bg-white rounded-lg border-2 border-emerald-200 p-4 shadow-sm flex flex-col justify-center">
                            ...
                            <span
                              className={`inline-flex items-center px-2.5 py-1.5 rounded-full text-xs font-bold whitespace-nowrap ${
                                service?.is_billable === true || service?.is_billable === 1
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-3 gap-2">
                            <div
                              className={`flex items-center gap-2.5 rounded-lg border-2 p-3 transition shadow-sm ${
                            ...
                            >
                              <span
                                className={`w-4 h-4 rounded-full font-bold text-sm flex items-center justify-center ${
                                  service?.allow_scheduling_fit
                            ...
                            <div
                              className={`flex items-center gap-2.5 rounded-lg border-2 p-3 transition ${
                                service?.active
                                  ? 'bg-green-50 border-green-300'
                    ...
                    <div className="bg-gradient-to-br from-amber-50 to-yellow-50 border-2 border-amber-200 rounded-xl p-5">
                      <div className="flex items-center gap-2 mb-5">
                        ...
                        <h4 className="text-sm font-bold text-amber-950 uppercase tracking-widest">
                          📋 Dados TISS
                        </h4>
                      </div>
                      <div className="grid grid-cols-3 gap-3">
                    ...
                    <div className="bg-gradient-to-br from-violet-50 to-purple-50 border-2 border-violet-200 rounded-xl p-5">
                      <div className="flex items-center gap-2 mb-5">
                        ...
                        <h4 className="text-sm font-bold text-violet-950 uppercase tracking-widest">
                          ⚙️ Customização do Profissional
                        </h4>
                      </div>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setEditForm({
                                ...editForm,
                                duration_minutes_override: e.target.value,
                              })
                            }
                          ...
                          />
                          <p className="text-xs text-violet-600 mt-1.5 italic">
                        ...
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setEditForm({ ...editForm, competence_level: e.target.value })
                            }
                            className="w-full px-4 py-2.5 border-2 border-violet-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 font-semibold bg-white"
                          >
                        ...
                        <div className="flex items-center gap-3 bg-white rounded-lg border-2 border-violet-200 p-4 cursor-pointer hover:bg-violet-50 transition">
                          ...
                          />
                          <label
                            htmlFor="active-assignment"
                            className="text-sm font-semibold text-violet-900 cursor-pointer flex-1"
                          >
