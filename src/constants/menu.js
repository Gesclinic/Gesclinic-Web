      ...
      children: [
        ...
        // 2. MOVIMENTO - Core Transactions (Motor Financeiro)
        {
          ...
          children: [
            ...
            {
              id: 'financeiro.conciliacao_cartoes',
              label: 'Conciliação de Cartões',
              icon: 'CreditCard',
              path: '/clinica/financeiro/conciliacao-cartoes',
              roles: ['admin', 'gestor', 'financeiro'],
              featurePath: 'financeiro.conciliacao_cartoes',
            },
            {
              id: 'financeiro.pagar',
        ...
        // 3. ESTRUTURA - Configuração Financeira
        {
          ...
          children: [
            ...
            {
              id: 'financeiro.plano_financeiro',
              label: 'Plano Financeiro',
              icon: 'ListTree',
              path: '/clinica/financeiro/plano-financeiro',
              roles: ['admin', 'gestor', 'financeiro'],
              featurePath: 'financeiro.plano_financeiro',
            },
            {
