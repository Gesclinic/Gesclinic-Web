-- Ensure enterprise chart template is fully applied even when the clinic already has seeded rows
-- Fix: update existing rows instead of ignoring conflicts
...
BEGIN
  ...
  UPDATE public.financial_chart_of_accounts account
  SET
    name = seed.name,
    ...
    is_active = true,
    status = 'ATIVA',
    accepts_entries = seed.allows_posting,
    allows_posting = seed.allows_posting,
    requires_cost_center = seed.requires_cost_center,
    is_analytic = seed.allows_posting,
    is_synthetic = NOT seed.allows_posting,
    color = seed.color,
    icon = seed.icon,
    category = seed.category,
    subcategory = seed.subcategory,
    group_name = seed.group_name,
    integration_key = seed.integration_key,
    dimension_config = jsonb_build_object(
      'category', true,
      'subcategory', true,
      'group', true,
      'cost_center', true,
    ...
    metadata = jsonb_build_object('seed', 'erp_hospital_enterprise', 'version', '2026-06-18'),
    updated_at = v_now
  FROM seed_dedup seed
  ...
  WITH seed(code, parent_code) AS (
    VALUES
      ('1', NULL), ('1.1', '1'), ('1.2', '1'), ('1.2.1', '1.2'), ('1.2.2', '1.2'), ('1.2.3', '1.2'), ('1.2.4', '1.2'), ('1.2.5', '1.2'), ('1.3', '1'), ('1.4', '1'), ('1.5', '1'), ('1.6', '1'), ('1.7', '1'), ('1.8', '1'), ('1.9', '1'),
      ('2', NULL), ('2.1', '2'), ('2.2', '2'), ('2.3', '2'), ('2.4', '2'), ('2.5', '2'), ('2.6', '2'), ('2.7', '2'),
      ('3', NULL), ('3.1', '3'), ('3.2', '3'), ('3.3', '3'), ('3.4', '3'), ('3.5', '3'), ('3.6', '3'), ('3.7', '3'), ('3.8', '3'),
      ('4', NULL), ('4.1', '4'), ('4.2', '4'), ('4.3', '4'), ('4.4', '4'), ('4.5', '4'),
      ('5', NULL), ('5.1', '5'), ('5.2', '5'), ('5.3', '5'), ('5.4', '5'), ('5.5', '5'), ('5.6', '5'), ('5.7', '5'),
      ('6', NULL), ('6.1', '6'), ('6.2', '6'), ('6.3', '6'), ('6.4', '6'), ('6.5', '6'), ('6.6', '6'), ('6.7', '6'), ('6.8', '6'), ('6.9', '6'), ('6.10', '6'),
      ('7', NULL), ('7.1', '7'), ('7.2', '7'), ('7.3', '7'), ('7.4', '7'), ('7.5', '7'),
      ('8', NULL), ('8.1', '8'), ('8.2', '8'), ('8.3', '8'), ('8.4', '8'),
      ('9', NULL), ('9.1', '9'), ('9.2', '9'), ('9.3', '9')
  )
