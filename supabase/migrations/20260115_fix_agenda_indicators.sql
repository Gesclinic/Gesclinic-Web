...
COMMENT ON FUNCTION get_agenda_indicators(UUID, DATE, UUID) IS 'Retorna indicadores consolidados da agenda para um dia específico';
COMMENT ON FUNCTION get_professional_indicators(UUID, UUID, DATE) IS 'Retorna indicadores específicos de um profissional em um dia';
