...
CREATE INDEX IF NOT EXISTS idx_audit_log_clinic_id ON appointment_audit_log(clinic_id);
CREATE INDEX IF NOT EXISTS idx_audit_log_appointment_id ON appointment_audit_log(appointment_id);
CREATE INDEX IF NOT EXISTS idx_audit_log_changed_at ON appointment_audit_log(changed_at DESC);
CREATE INDEX IF NOT EXISTS idx_audit_log_operation ON appointment_audit_log(operation);
CREATE INDEX IF NOT EXISTS idx_audit_log_changed_by ON appointment_audit_log(changed_by);
CREATE INDEX IF NOT EXISTS idx_audit_log_before_snapshot ON appointment_audit_log USING GIN(before_snapshot);
CREATE INDEX IF NOT EXISTS idx_audit_log_after_snapshot ON appointment_audit_log USING GIN(after_snapshot);

ALTER TABLE appointment_audit_log ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS "clinic_admins_can_view_audit_logs" ON appointment_audit_log;
...
CREATE INDEX IF NOT EXISTS idx_audit_summary_clinic_id ON appointment_audit_summary(clinic_id);
CREATE INDEX IF NOT EXISTS idx_audit_summary_date ON appointment_audit_summary(summary_date DESC);

ALTER TABLE appointment_audit_summary ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS "clinic_admins_can_view_summary" ON appointment_audit_summary;
