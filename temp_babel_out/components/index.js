...
export default function AgendaIndex() {
    ...
    const loadUserProfessionalId = async () => {
      ...
      try {
        const {
          data: allProfs,
          error
        } = await supabase.from('professionals').select('id, email').eq('email', auth.user.email).eq('clinic_id', clinicId);
  ...
  const loadAppointments = useCallback(async () => {
    console.log(' [loadAppointments] INICIANDO', {
      viewMode,
      clinicId
    });
    if (!clinicId) {
    ...
    try {
      ...
      if (currentRole?.toLowerCase?.() === 'profissional' && auth?.user?.email) {
        const {
          data: profData
        } = await supabase.from('professionals').select('id').eq('email', auth.user.email).eq('clinic_id', clinicId).maybeSingle();
        if (profData?.id) {
      ...
      const [appts, profs, svcs, pays] = await Promise.all([listAppointments({
        clinicId,
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, whatsappResult && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
      bottom: '20px',
      right: '20px',
  ...
  }, "Enviadas: ", /*#__PURE__*/React.createElement("span", {
    style: {
      fontWeight: '700'
    }
  }, whatsappResult.sent, "/", whatsappResult.total), whatsappResult.failed > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: '4px',
      color: '#D97706'
    }
  }, "\u26A0\uFE0F ", whatsappResult.failed, " falharam"))))), whatsappError && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
      bottom: '20px',
      right: '20px',
  ...
  }, whatsappError)))), /*#__PURE__*/React.createElement(AgendaHeaderNew, {
    date: date,
  ...
  }), /*#__PURE__*/React.createElement(AgendaToolbarNew, {
    viewMode: agendaMode,
  ...
  }), /*#__PURE__*/React.createElement(AgendaFiltersNew, {
    filters: filters,
    ...
    className: "px-4 py-3 bg-white border-b border-gray-100 flex items-center justify-between gap-6"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, filteredAppointments.length), /*#__PURE__*/React.createElement("span", {
    className: "text-xs text-gray-600 mt-0.5"
  }, "Atendimentos")), /*#__PURE__*/React.createElement("div", {
    className: "w-px h-7 bg-gray-200"
  }), /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col items-center"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-lg font-bold text-green-600"
  }, filteredAppointments.length > 0 ? Math.max(0, 20 - filteredAppointments.length) : 20), /*#__PURE__*/React.createElement("span", {
    className: "text-xs text-gray-600 mt-0.5"
  ...
  }, filteredAppointments.length > 0 ? Math.round(filteredAppointments.length / 20 * 100) : 0, "%"), /*#__PURE__*/React.createElement("span", {
    className: "text-xs text-gray-600 mt-0.5"
    ...
    className: `px-2.5 py-1 text-xs font-medium text-white rounded transition-all flex items-center gap-1 ${whatsappLoading ? 'bg-green-500 cursor-not-allowed opacity-75' : 'hover:scale-105 active:scale-95'} ${whatsappLoading ? 'whatsapp-pulse-btn' : ''}`,
    style: {
      backgroundImage: whatsappLoading ? 'none' : 'linear-gradient(135deg, #25D366 0%, #128C7E 100%)',
  ...
  }, whatsappLoading ? '⏳' : ''), /*#__PURE__*/React.createElement("span", {
    className: "hidden sm:inline"
  }, whatsappLoading ? 'Enviando...' : 'Confirmar')))), agendaMode === 'profissional' ?
  /*#__PURE__*/
  // MODO PROFISSIONAL - Horários disponíveis por profissional (Dia/Semana/Mês)
  React.createElement("div", {
    className: "flex-1 mt-4 bg-white border border-gray-200 rounded-lg overflow-hidden"
  }, (() => {
    ...
    console.log(`   ViewMode: ${viewMode}`);
    return null;
  })(), /*#__PURE__*/React.createElement(AgendaPorProfissional, {
    initialDate: date,
    viewMode: viewMode,
  ...
  React.createElement("div", {
    className: "flex-1 mt-4 bg-white border border-gray-200 rounded-lg overflow-hidden"
  }, /*#__PURE__*/React.createElement(AgendaSalaPlaceholder, null)) : viewMode === 'semana' ?
  /*#__PURE__*/
  // WEEK VIEW
  React.createElement("div", {
    className: "flex-1 mt-4 bg-white border border-gray-200 rounded-lg overflow-hidden"
  }, /*#__PURE__*/React.createElement(AgendaWeekView, {
    date: date,
    appointments: filteredAppointments,
  ...
  React.createElement("div", {
    className: "flex-1 mt-4 bg-white border border-gray-200 rounded-lg overflow-hidden"
  }, /*#__PURE__*/React.createElement(AgendaMonthView, {
    date: date,
    appointments: filteredAppointments,
    onDayClick: handleDateChange,
    onBookSlot: handleSlotClick,
  ...
  React.createElement("div", {
    className: "flex-1 mt-4 bg-white border border-gray-200 rounded-lg overflow-hidden"
  }, console.log(' [RENDER AgendaIndex] Renderizando AgendaDayView com onEditAppointment:', typeof handleEditAppointment === 'function' ? '✅ FUNCTION' : '❌ NÃO É FUNÇÃO'), /*#__PURE__*/React.createElement(AgendaDayView, {
    appointments: filteredAppointments,
    onBookSlot: handleSlotClick,
    onEditAppointment: handleEditAppointment,
    onViewDetails: handleViewDetails,
    ...
    className: "w-4 h-4"
  }), "Editar (ou duplo clique)"), auth?.currentRole === 'profissional' && /*#__PURE__*/React.createElement("button", {
    onClick: () => {
    ...
    className: "w-4 h-4"
  }), "Detalhes")), /*#__PURE__*/React.createElement(ModalCriarAgendamento, {
    open: modalNovoOpen,
  ...
  }), detailsDrawerOpen && selectedAppointmentDetails && /*#__PURE__*/React.createElement("div", {
    className: "fixed inset-0 z-50 flex"
  }, /*#__PURE__*/React.createElement("div", {
    className: "absolute inset-0 bg-black/50 transition-opacity",
    onClick: () => setDetailsDrawerOpen(false)
  }), /*#__PURE__*/React.createElement("div", {
    className: "relative ml-auto w-full max-w-md bg-white shadow-2xl flex flex-col max-h-screen overflow-y-auto"
  }, /*#__PURE__*/React.createElement("div", {
    className: "sticky top-0 bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6 flex items-center justify-between border-b"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "text-xl font-bold"
  }, "Detalhes do Agendamento"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setDetailsDrawerOpen(false),
  ...
  }, selectedAppointmentDetails.patients?.name || selectedAppointmentDetails.lead_name || '—'), selectedAppointmentDetails.patients?.document_id && /*#__PURE__*/React.createElement("p", {
    className: "text-sm text-gray-600 mt-1"
  }, "CPF: ", selectedAppointmentDetails.patients.document_id), selectedAppointmentDetails.patients?.prontuario_numero && /*#__PURE__*/React.createElement("p", {
    className: "text-sm text-gray-600"
  }, "Prontu\xE1rio: ", selectedAppointmentDetails.patients.prontuario_numero)), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-2 gap-4"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    className: "text-sm font-semibold text-gray-500 uppercase tracking-wide"
  }, "Data"), /*#__PURE__*/React.createElement("p", {
    className: "text-base font-semibold text-gray-900 mt-1"
  }, selectedAppointmentDetails.scheduled_date ? new Date(selectedAppointmentDetails.scheduled_date).toLocaleDateString('pt-BR') : '—')), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    className: "text-sm font-semibold text-gray-500 uppercase tracking-wide"
  }, "Hor\xE1rio"), /*#__PURE__*/React.createElement("p", {
    className: "text-base font-semibold text-gray-900 mt-1"
  }, selectedAppointmentDetails.scheduled_time || '—'))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    className: "text-sm font-semibold text-gray-500 uppercase tracking-wide"
  }, "Servi\xE7o"), /*#__PURE__*/React.createElement("p", {
    className: "text-base text-gray-900 mt-1"
  }, selectedAppointmentDetails.services?.name || '—')), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    className: "text-sm font-semibold text-gray-500 uppercase tracking-wide"
  }, "Profissional"), /*#__PURE__*/React.createElement("p", {
    className: "text-base text-gray-900 mt-1"
  }, selectedAppointmentDetails.professionals?.name || '—')), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    className: "text-sm font-semibold text-gray-500 uppercase tracking-wide"
  }, "Sala"), /*#__PURE__*/React.createElement("p", {
    className: "text-base text-gray-900 mt-1"
  }, selectedAppointmentDetails.rooms?.name || '—')), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    className: "text-sm font-semibold text-gray-500 uppercase tracking-wide"
  }, "Conv\xEAnio"), /*#__PURE__*/React.createElement("p", {
    className: "text-base text-gray-900 mt-1"
  }, selectedAppointmentDetails.payers?.active === false ? '—' : selectedAppointmentDetails.payers?.name || 'Particular')), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    className: "text-sm font-semibold text-gray-500 uppercase tracking-wide"
  }, "Plano"), /*#__PURE__*/React.createElement("p", {
    className: "text-base text-gray-900 mt-1"
  }, selectedAppointmentDetails.plans?.name || '—'), selectedAppointmentDetails.plans?.code && /*#__PURE__*/React.createElement("p", {
    className: "text-sm text-gray-600 mt-1"
  }, "C\xF3digo: ", selectedAppointmentDetails.plans.code)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    className: "text-sm font-semibold text-gray-500 uppercase tracking-wide"
  }, "Status"), /*#__PURE__*/React.createElement("p", {
    className: "text-base font-semibold mt-1"
  }, /*#__PURE__*/React.createElement("span", {
    className: `inline-block px-3 py-1 rounded-full text-sm font-medium ${getStatusConfig(selectedAppointmentDetails.status)?.color || 'bg-gray-100 text-gray-800'}`
  }, getStatusLabelOnly(selectedAppointmentDetails.status) || selectedAppointmentDetails.status || 'desconhecido'))), selectedAppointmentDetails.value && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    className: "text-sm font-semibold text-gray-500 uppercase tracking-wide"
  }, "Valor"), /*#__PURE__*/React.createElement("p", {
    className: "text-lg font-bold text-gray-900 mt-1 text-green-600"
  }, "R$ ", parseFloat(selectedAppointmentDetails.value).toFixed(2))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    className: "text-sm font-semibold text-gray-500 uppercase tracking-wide"
  }, "Contato"), selectedAppointmentDetails.patients?.cell_phone && /*#__PURE__*/React.createElement("p", {
    className: "text-sm text-gray-900 mt-1"
  }, " ", selectedAppointmentDetails.patients.cell_phone), selectedAppointmentDetails.patients?.phone && /*#__PURE__*/React.createElement("p", {
    className: "text-sm text-gray-900"
  }, "\u260E\uFE0F ", selectedAppointmentDetails.patients.phone)), selectedAppointmentDetails.notes && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    className: "text-sm font-semibold text-gray-500 uppercase tracking-wide"
  }, "Observa\xE7\xF5es"), /*#__PURE__*/React.createElement("p", {
    className: "text-sm text-gray-700 mt-1 p-3 bg-gray-50 rounded border border-gray-200"
