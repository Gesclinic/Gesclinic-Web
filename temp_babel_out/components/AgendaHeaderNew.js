...
export default function AgendaHeaderNew({
  ...
  if (isNaN(dateObj.getTime())) {
    return /*#__PURE__*/React.createElement("div", {
      className: "bg-white border-b border-gray-200 sticky top-0 z-20 shadow-sm px-6 py-2"
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "px-6 py-2.5 flex items-center justify-between gap-6"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "w-4 h-4"
  })), /*#__PURE__*/React.createElement(DatePickerPopover, {
