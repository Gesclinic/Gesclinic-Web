...
import { getAppointmentFinancialAuditTrail, getAppointmentFinancialSummary, checkFinancialDivergences } from "@/lib/auditFinancialApi";
export function useAppointmentFinancialAudit(appointmentId, options = {}) {
  ...
  const loadAudit = useCallback(async appointmentId => {
