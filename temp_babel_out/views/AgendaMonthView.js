...
export default function AgendaMonthView({
  ...
  // NOVO: ID do profissional filtrado
  userRole = null,
  ...
  // Parse da data
  const [year, month, day] = date ? date.split('-').map(Number) : [new Date().getFullYear(), new Date().getMonth() + 1, new Date().getDate()];
    ...
    const loadProfessionalAvailability = async () => {
      ...
      try {
        ...
        const promises = monthDays.map(day => {
          ...
          return getProfessionalAvailableSlots(profIdToLoad, dayStr).then(slots => ({
            dayStr,
        ...
        results.forEach(({
          ...
          if (hasAvailability) availableCount++;else unavailableCount++;
        });
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, weeks.map((week, weekIdx) => /*#__PURE__*/React.createElement("div", {
    key: weekIdx,
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      onClick: () => {
        ...
        if (profAvailability && profAvailability.hasAvailability) {
          const firstSlot = profAvailability.slots && profAvailability.slots.length > 0 ? profAvailability.slots[0] : '09:00';
      ...
      style: {
        background: (() => {
          ...
          if (dayAppts.length > 0) {
            ...
            const {
              background
            } = getStatusStyle(dayAppts[0]?.status);
            return background;
          }
          return '#fafaf9';
        })(),
      ...
      return isBlocked ? /*#__PURE__*/React.createElement("div", {
        className: "absolute inset-0 bg-gray-300/60 flex flex-col items-center justify-center rounded pointer-events-none"
      }, /*#__PURE__*/React.createElement("span", {
        className: "text-2xl"
      }, "\uD83D\uDD12"), /*#__PURE__*/React.createElement("span", {
        className: "text-xs font-semibold text-gray-700 mt-1 text-center px-1 max-w-[90%] whitespace-normal line-clamp-2"
      }, dayHoliday.name)) : null;
    })(), (() => {
      const dayHoliday = holidaysMap[dayKey];
      const isOptional = dayHoliday && dayHoliday.is_mandatory === false && !dayHoliday.has_override;
      return isOptional ? /*#__PURE__*/React.createElement("div", {
        className: "absolute inset-0 bg-yellow-200/30 border-2 border-yellow-400/50 rounded pointer-events-none"
      }) : null;
    })(), (() => {
      const dayHoliday = holidaysMap[dayKey];
      return dayHoliday && dayHoliday.has_override ? /*#__PURE__*/React.createElement("div", {
        className: "absolute inset-0 bg-green-200/20 border border-green-400/50 rounded pointer-events-none"
      }) : null;
    })(), /*#__PURE__*/React.createElement("div", {
      className: "text-sm font-bold mb-2 text-gray-900"
    }, format(dayObj, 'd')), /*#__PURE__*/React.createElement("div", {
    ...
    React.createElement("div", {
      ...
      const displayName = nameParts.length > 1 ? `${nameParts[0]} ${nameParts[nameParts.length - 1]}` : nameParts[0] || 'Paciente';
      return /*#__PURE__*/React.createElement("div", {
        key: apt.id,
        onClick: e => {
          e.stopPropagation();
    ...
    }), dayAppts.length > 2 && /*#__PURE__*/React.createElement("div", {
      className: "text-xs text-gray-600 mt-1"
    }, "+", dayAppts.length - 2, " mais")) : isCurrentMonth && !isHolidayBlocked ?
    /*#__PURE__*/
    // Quando não tem agendamentos e está no mês atual e não é feriado
    React.createElement(React.Fragment, null, isProfessionalUnavailable ?
    /*#__PURE__*/
    ...
    }, /*#__PURE__*/React.createElement("div", null, "Clique para"), /*#__PURE__*/React.createElement("div", null, "agendar"))) : null), hoveredDay === dayKey && dayAppts.length > 0 && /*#__PURE__*/React.createElement("div", {
      className: "absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white text-xs rounded px-2 py-1.5 pointer-events-none z-50 max-w-xs"
    }, dayAppts.map((apt, idx) => /*#__PURE__*/React.createElement("div", {
      key: idx,
      className: "whitespace-nowrap truncate"
    }, /*#__PURE__*/React.createElement("span", {
      className: "font-semibold"
    }, apt.scheduled_time ? apt.scheduled_time.substring(0, 5) : 'S/H'), " \u2022 ", apt.patient_name || 'Paciente')), /*#__PURE__*/React.createElement("div", {
      className: "absolute top-full left-1/2 transform -translate-x-1/2 border-2 border-transparent border-t-gray-900"
    })));
  })))), /*#__PURE__*/React.createElement("div", {
  ...
  }), /*#__PURE__*/React.createElement("span", null, "Indispon\xEDvel")), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-lg"
  }, "\uD83D\uDD12"), /*#__PURE__*/React.createElement("span", null, "Feriado bloqueado")), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "w-3 h-3 rounded bg-yellow-300 border border-yellow-400"
  }), /*#__PURE__*/React.createElement("span", null, "Feriado facultativo")), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "w-3 h-3 rounded bg-green-200 border border-green-400"
  }), /*#__PURE__*/React.createElement("span", null, "Feriado com override")), filteredProfessionalId && /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "w-3 h-3 rounded bg-orange-100 border border-orange-300"
  }, "\u274C"), /*#__PURE__*/React.createElement("span", null, "Profissional indispon\xEDvel")))));
}