...
const isTimeSlotAvailable = (professionalId, dayOfWeek, timeString, schedules) => {
  ...
  const profSchedules = schedules.filter(s => String(s.professional_id) === String(professionalId) && s.day_of_week === dayOfWeek && s.active !== false && !s.blocked);
...
export default function AgendaPorProfissional({
  ...
  useEffect(() => {
    if (!clinic?.id) return;
    setLoading(true);
    Promise.all([listProfessionals(clinic.id), listServices(clinic.id), listPayers(clinic.id), getClinicSchedules(clinic.id), listRooms(clinic.id)]).then(([profs, svcs, payers_, scheds, rms]) => {
    ...
    }).catch(err => console.error('Erro ao carregar dados de suporte:', err)).finally(() => setLoading(false));
  }, [clinic?.id]);
  ...
  const agendamentosFiltrados = useMemo(() => {
    ...
    if (isProfissional && user?.professional_id) {
      ...
      if (filtered.length > 0) {
        console.log(`   Detalhes:`, filtered.map(a => ({
          patient: a.patient_name,
          date: a.scheduled_date,
          time: a.scheduled_time
        })));
  ...
  const horariosPorProfissional = useMemo(() => {
    ...
    profissionaisFiltrados.forEach(prof => {
      const profSchedules = schedules.filter(s => String(s.professional_id) === String(prof.id) && s.day_of_week === dayOfWeek && s.active !== false && !s.blocked);
  ...
  const renderDiaView = () => {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, "Hor\xE1rio"), profissionaisFiltrados.map(prof => /*#__PURE__*/React.createElement("th", {
      key: prof.id,
      style: {
        padding: 12,
        border: '1px  solid #dee2e6',
    ...
    }, prof.name)))), /*#__PURE__*/React.createElement("tbody", null, (() => {
      ...
      if (horariosOrdenados.length === 0) {
        return /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("td", {
          colSpan: 1 + profissionaisFiltrados.length,
          style: {
            textAlign: 'center',
            padding: 48,
            color: '#6c757d',
        ...
        }, "\uD83D\uDCC5 Nenhum hor\xE1rio dispon\xEDvel"));
      }
      return horariosOrdenados.map(horario => /*#__PURE__*/React.createElement("tr", {
        key: horario,
        style: {
      ...
      }, horario), profissionaisFiltrados.map(prof => {
  ...
  const renderSemanaCompacta = () => {
    ...
    }, "\uD83D\uDD12 Agenda bloqueada em feriados"), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'grid',
    ...
    }, "Hor\xE1rio"), daysOfWeek.map(day => /*#__PURE__*/React.createElement("div", {
      key: day.toISOString(),
      style: {
        padding: 12,
        borderRight: '1px solid #dee2e6',
    ...
    }, /*#__PURE__*/React.createElement("div", null, format(day, 'EEE', {
      locale: ptBR
    })), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
    ...
    }, format(day, 'dd/MM'))))), /*#__PURE__*/React.createElement("div", {
      style: {
        overflowY: 'auto',
        maxHeight: 'calc(100vh - 300px)'
      }
    }, horariosOrdenados.length === 0 ? /*#__PURE__*/React.createElement("div", {
      style: {
        textAlign: 'center',
        padding: 48,
        color: '#6c757d'
      }
    }, "\uD83D\uDCC5 Nenhum agendamento") : horariosOrdenados.map(horario => /*#__PURE__*/React.createElement("div", {
      key: horario,
      style: {
        display: 'grid',
        gridTemplateColumns: '80px repeat(7, 1fr)',
  ...
  const renderSemanaView = () => {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, horariosOrdenados.map(horario => /*#__PURE__*/React.createElement("div", {
      key: horario,
      style: {
        display: 'grid',
        gridTemplateColumns: '80px repeat(7, 1fr)',
      ...
      return /*#__PURE__*/React.createElement("div", {
        key: `${dayStr}-${horario}`,
        onClick: () => {
          console.log('🎯 [AgendaPorProfissional] CLIQUE no slot:', {
            dayStr,
            horario,
            apt: !!apt,
            isAvailable,
  ...
  const renderMesView = () => {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "sticky top-0 z-20 bg-white border-b border-gray-200 shadow-sm px-6 py-4"
    ...
    }, ['Segunda', 'Terça', 'Quarta', 'Quinta', 'Sexta', 'Sábado', 'Domingo'].map(d => /*#__PURE__*/React.createElement("div", {
      key: d,
      ...
      if (profissionaisFiltrados && profissionaisFiltrados.length > 0) {
        ...
        isDayAvailable = profissionaisFiltrados.some(prof => {
          return schedules.some(s => String(s.professional_id) === String(prof.id) && s.day_of_week === supabaseDayOfWeek && s.active !== false && !s.blocked);
        });
      } else {
        // Se não há filtro específico, mostrar como disponível se houver algum schedule
        isDayAvailable = schedules.some(s => s.day_of_week === supabaseDayOfWeek && s.active !== false && !s.blocked);
      }
      return /*#__PURE__*/React.createElement("div", {
        key: dayStr,
        onClick: () => {
      ...
      }, format(day, 'd')), /*#__PURE__*/React.createElement("div", {
        className: "flex-1 flex items-center justify-center overflow-hidden"
      }, dayAppointments.length > 0 ? /*#__PURE__*/React.createElement("div", {
      ...
      }), dayAppointments.length > 2 && /*#__PURE__*/React.createElement("div", {
        className: "text-xs text-gray-600 mt-1"
      }, "+", dayAppointments.length - 2, " mais")) : isCurrentMonth ? /*#__PURE__*/React.createElement(React.Fragment, null, isDayAvailable ? /*#__PURE__*/React.createElement("div", {
        className: "text-xs font-black text-center",
        style: {
          color: '#10b981'
        }
      }, /*#__PURE__*/React.createElement("div", null, "Clique para"), /*#__PURE__*/React.createElement("div", null, "agendar")) : /*#__PURE__*/React.createElement("div", {
        className: "flex flex-col items-center justify-center gap-1"
      }, /*#__PURE__*/React.createElement("span", {
        className: "text-2xl"
      }, "\uD83D\uDD12"), /*#__PURE__*/React.createElement("span", {
        className: "text-xs font-semibold text-gray-600"
      }, "Indispon\xEDvel"))) : null));
    }))), /*#__PURE__*/React.createElement("div", {
    ...
    }), /*#__PURE__*/React.createElement("span", null, "Dispon\xEDvel")), /*#__PURE__*/React.createElement("div", {
      className: "flex items-center gap-2"
    }, /*#__PURE__*/React.createElement("span", {
      className: "w-3 h-3 rounded",
      style: {
    ...
    }), /*#__PURE__*/React.createElement("span", null, "Agendado")), /*#__PURE__*/React.createElement("div", {
      className: "flex items-center gap-2"
    }, /*#__PURE__*/React.createElement("span", {
      className: "w-3 h-3 rounded",
      style: {
    ...
    }), /*#__PURE__*/React.createElement("span", null, "Confirmado")), /*#__PURE__*/React.createElement("div", {
      className: "flex items-center gap-2"
    }, /*#__PURE__*/React.createElement("span", {
      className: "w-3 h-3 rounded",
      style: {
    ...
    }), /*#__PURE__*/React.createElement("span", null, "Atendimento")), /*#__PURE__*/React.createElement("div", {
      className: "flex items-center gap-2"
    }, /*#__PURE__*/React.createElement("span", {
      className: "w-3 h-3 rounded",
      style: {
    ...
    }), /*#__PURE__*/React.createElement("span", null, "Indispon\xEDvel")))));
  };
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Agenda por Profissional"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8,
      alignItems: 'center'
    }
  }, /*#__PURE__*/React.createElement(AgendaViewModeTabs, {
  ...
  }, "Novo Agendamento"), /*#__PURE__*/React.createElement("input", {
    type: "date",
    value: date,
  ...
  }), !isProfissional && /*#__PURE__*/React.createElement(AgendaFilters, {
    ...
    showStatus: false,
    showPatient: false
  }))), currentViewMode === 'semana' ? renderSemanaView() : currentViewMode === 'mes' ? renderMesView() : renderDiaView(), /*#__PURE__*/React.createElement(AppointmentUnitedModal, {
    isOpen: !!selectedSlot,
    onClose: () => {
      setSelectedSlot(null);
      setSelectedSlotData(null);
  ...
  }), novoAgendamento && /*#__PURE__*/React.createElement(ModalCriarAgendamento, {
  ...
  }), selectedSlot && selectedSlotData && /*#__PURE__*/React.createElement(ModalCriarAgendamento, {
    open: !!selectedSlot,
