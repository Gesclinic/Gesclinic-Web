...
// APIs
import { listAppointments, createAppointment, updateAppointment, deleteAppointment } from '@/lib/appointmentsApi';
...
import { validateAppointmentScheduling, calculateAppointmentData, listProfessionalsForService } from '@/lib/agendaIntegrationApi';
...
export default function AgendaPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const [professionals, rooms, services, payers, patients] = await Promise.all([listProfessionals(clinicId).catch(err => {
  ...
  const metrics = useMemo(() => {
    return useAgendaFinanceMetrics(agenda.filteredAppointments || [], agenda.metadata?.professionals || [], agenda.metadata?.services || [], agenda.date);
  ...
  const professionalAppointments = useMemo(() => {
    ...
    if (userProfessionalId) {
      ...
      const filtered = agenda.filteredAppointments.filter(a => a.professional_id === userProfessionalId);
    ...
    try {
      ...
      if (isProf && user?.email) {
        ...
        const {
          data: allProfs,
          error: profError
        } = await supabase.from('professionals').select('id, email, clinic_id, name').eq('email', user.email).eq('clinic_id', clinicId);
  ...
  useEffect(() => {
    ...
    supabase.from('appointments').select('*') // Buscar TODOS os campos para debugar
    .eq('id', appointmentIdFromUrl).eq('clinic_id', clinicId).maybeSingle().then(({
      data,
      error
    }) => {
      if (error) {
  ...
  useEffect(() => {
    console.log('🔔 [AutoOpen Checkin] useEffect DISPAROU!', {
      appointmentIdFromUrl
    });
  ...
  const handleBlockAppointment = async slot => {
    ...
    try {
      ...
      if (agenda.metadata?.patients?.length > 0) {
        const blockPatient = agenda.metadata.patients.find(p => p.name?.toUpperCase?.() === 'BLOQUEIO' || p.id === 'bloqueio');
  ...
  if (loadingClinic || !clinic) {
    console.log('⏳ [AgendaPage] AINDA EM LOADING:', {
      loadingClinic,
      clinic: !!clinic
    });
    ...
    }, "Carregando cl\xEDnica... (loadingClinic=", loadingClinic.toString(), ", clinic=", !!clinic, ")")));
  }
  ...
  if (loadingClinic || !clinicId) {
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "h-12 w-12 border-4 border-blue-300 border-t-blue-600 rounded-full"
    }))), /*#__PURE__*/React.createElement("p", {
      className: "text-lg font-semibold text-gray-700 mb-2"
    }, "Verificando configura\xE7\xE3o..."), /*#__PURE__*/React.createElement("p", {
      className: "text-sm text-gray-500"
    }, "Cl\xEDnica: ", clinicId ? '✅ Carregada' : '⏳ Carregando'), /*#__PURE__*/React.createElement("p", {
      className: "text-sm text-gray-500"
    }, "Auth: ", authLoading ? '⏳ Carregando' : '✅ Pronto')));
  }
  return /*#__PURE__*/React.createElement("div", {
    className: "min-h-screen bg-gray-50 pb-8"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-full bg-red-200 border-b-4 border-red-600 px-4 py-3"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex gap-4 text-sm font-mono"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "\uD83D\uDD0D Debug:"), " Role=", currentRole, " | Mode=", agendaMode, " | Prof=", isProfessional ? userProfessionalId || 'loading' : 'N/A'), /*#__PURE__*/React.createElement("div", null, "| Auth Loading=", authLoading, " | Clinic Loading=", loadingClinic))), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
      top: '20px',
      right: '20px',
  ...
  }, "\uD83D\uDD25 TESTE: ", whatsappLoading ? 'Enviando...' : 'CLIQUE AQUI')), agendaMode === 'profissional' ? /*#__PURE__*/React.createElement("div", {
    className: "w-full py-6"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-full mx-auto px-4 mb-6"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between mb-4"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h1", {
    className: "text-3xl font-bold text-gray-900 flex items-center gap-3"
  }, "\uD83D\uDC68\u200D\u2695\uFE0F Meus Atendimentos"), user && /*#__PURE__*/React.createElement("p", {
    className: "text-sm text-gray-600 mt-1"
  }, "\uD83D\uDC64 ", user.user_metadata?.name || 'Profissional')), /*#__PURE__*/React.createElement("button", {
  ...
  }, /*#__PURE__*/React.createElement(AgendaProfessionalFilters, {
    agenda: agenda,
    isGestor: isGestor,
  ...
  }, !userProfessionalId && /*#__PURE__*/React.createElement("div", {
  ...
  }, "Sem Profissional Associado"), /*#__PURE__*/React.createElement("p", {
    className: "text-sm text-yellow-700 mt-1"
  }, "Seu usu\xE1rio n\xE3o est\xE1 associado a um profissional no sistema.", canAccessGestorMode && ' Você pode voltar à visualização Geral para gerenciar todos os agendamentos.'))), /*#__PURE__*/React.createElement(AgendaProfessionalView, {
  ...
  React.createElement("div", {
    ...
    className: "mb-6 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-4 flex items-center gap-3"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-2xl"
  }, "\uD83D\uDCC5"), /*#__PURE__*/React.createElement("div", {
    className: "flex-1"
  ...
  }, "Agenda \xDAnica da Cl\xEDnica"), /*#__PURE__*/React.createElement("p", {
    className: "text-sm text-blue-700"
  }, "Escolha a visualiza\xE7\xE3o abaixo: Geral, Por Profissional ou Por Sala")), /*#__PURE__*/React.createElement("div", {
    className: "group relative inline-block"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-sm bg-blue-100 text-blue-800 px-3 py-1 rounded-full font-medium cursor-help"
  }, "\u2139\uFE0F URL: /clinica/agenda"), /*#__PURE__*/React.createElement("div", {
    className: "hidden group-hover:block absolute bottom-full right-0 mb-2 bg-gray-800 text-white text-xs px-3 py-2 rounded whitespace-nowrap z-50"
  }, "A URL permanece /clinica/agenda ao trocar abas", /*#__PURE__*/React.createElement("div", {
    className: "absolute top-full right-3 w-0 h-0 border-l-4 border-r-4 border-t-4 border-l-transparent border-r-transparent border-t-gray-800"
  })))), /*#__PURE__*/React.createElement("div", {
    className: "mb-6"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "text-sm font-semibold text-gray-700 mb-2"
  }, "Modo de Visualiza\xE7\xE3o:"), /*#__PURE__*/React.createElement(AgendaTabs, {
    viewMode: agenda.viewMode,
    onViewModeChange: agenda.setViewMode
  })), currentRole !== 'recepcao' && /*#__PURE__*/React.createElement("div", {
    className: "mb-6 pb-4 border-b border-gray-200"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    className: "text-sm font-semibold text-gray-700"
  }, "Modo da Agenda:"), /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-gray-500 mt-1"
  }, agendaMode === 'recepcao' ? '📞 Recepção - Visualização operacional simplificada' : agendaMode === 'profissional' ? '👨‍⚕️ Profissional - Apenas meus atendimentos' : '📊 Gestor - Análises financeiras e ocupação')), /*#__PURE__*/React.createElement("div", {
    className: "flex gap-2 bg-gray-100 p-1 rounded-lg"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setAgendaMode('recepcao'),
    className: `px-4 py-2 rounded-md text-sm font-medium transition-all ${agendaMode === 'recepcao' ? 'bg-white text-blue-600 shadow-sm border border-gray-200' : 'text-gray-600 hover:text-gray-900'}`
  }, "\uD83D\uDCDE Recep\xE7\xE3o"), canAccessProfessionalMode && /*#__PURE__*/React.createElement("button", {
    onClick: () => setAgendaMode('profissional'),
    className: `px-4 py-2 rounded-md text-sm font-medium transition-all ${agendaMode === 'profissional' ? 'bg-white text-blue-600 shadow-sm border border-gray-200' : 'text-gray-600 hover:text-gray-900'}`
  }, "\uD83D\uDC68\u200D\u2695\uFE0F Profissional"), canAccessGestorMode && /*#__PURE__*/React.createElement("button", {
    onClick: () => setAgendaMode('gestor'),
    className: `px-4 py-2 rounded-md text-sm font-medium transition-all ${agendaMode === 'gestor' ? 'bg-white text-blue-600 shadow-sm border border-gray-200' : 'text-gray-600 hover:text-gray-900'}`
  }, "\uD83D\uDCCA Gestor")))), /*#__PURE__*/React.createElement(AgendaFilters, {
    viewMode: agenda.viewMode,
    ...
    metadata: agenda.metadata,
    currentRole: currentRole
  }), agenda.error && /*#__PURE__*/React.createElement("div", {
    className: "mb-6 p-4 bg-red-100 border border-red-300 text-red-700 rounded-lg"
  }, agenda.error), agendaMode === 'gestor' && !agenda.loading && metrics && /*#__PURE__*/React.createElement(CollapsibleSection, {
    title: "Gest\xE3o Financeira da Agenda",
    icon: "\uD83D\uDCB0",
    ...
    defaultOpen: false,
    className: "mb-8"
  }, /*#__PURE__*/React.createElement(AgendaFinanceDashboard, {
    metrics: metrics,
    loading: agenda.loading
  })), agendaMode === 'gestor' && !agenda.loading && encaixeSuggestions.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "mb-6"
  }, /*#__PURE__*/React.createElement(EncaixeSuggestions, {
  ...
  })), agendaMode === 'gestor' && !agenda.loading && /*#__PURE__*/React.createElement(CollapsibleSection, {
    title: "Heatmap de Ocupa\xE7\xE3o",
    icon: "\uD83D\uDD25",
    ...
    defaultOpen: false,
    className: "mb-8"
  }, /*#__PURE__*/React.createElement(AgendaHeatmap, {
    ...
    viewMode: agenda.viewMode,
    columnCount: agenda.viewMode === 'profissional' ? agenda.metadata.professionals?.length || 1 : agenda.viewMode === 'sala' ? agenda.metadata.rooms?.length || 1 : 1,
  ...
  })), clinicId && agendaMode === 'gestor' && !agenda.loading && /*#__PURE__*/React.createElement(CollapsibleSection, {
    title: "Indicadores da Agenda",
    icon: "\uD83D\uDCCA",
    summary: "Status geral, ocupa\xE7\xE3o e m\xE9tricas financeiras",
    storageKey: "agenda-indicators-open",
    defaultOpen: true,
    className: "mb-8"
  }, /*#__PURE__*/React.createElement(AgendaIndicators, {
    clinicId: clinicId,
    date: agenda.date,
  ...
  })), agenda.loading ? /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-center h-96"
  }, /*#__PURE__*/React.createElement("div", {
    className: "animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600"
  })) : /*#__PURE__*/React.createElement(AgendaTimeline, {
    viewMode: agenda.viewMode,
    date: agenda.date,
    appointments: agenda.filteredAppointments,
    onSlotClick: handleSlotClick,
  ...
  }), /*#__PURE__*/React.createElement(CheckinDrawer, {
    isOpen: checkinOpen,
    appointment: checkinAppointment,
    onClose: handleCloseCheckin,
    onStatusChange: handleCloseCheckin
  }), /*#__PURE__*/React.createElement(AtendimentoModal, {
