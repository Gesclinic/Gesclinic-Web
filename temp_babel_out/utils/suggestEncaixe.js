  ...
  horarios.forEach(horario => {
    profissionais.forEach(profissional => {
      salas.forEach(sala => {
        ...
        const livre = checkDisponibilidade(horario, profissional, sala, agendamentos, servico.duracao);
        if (!livre) return;
        ...
        const consecutivos = countConsecutivosLivres(horario, horarios, profissional, sala, agendamentos);
